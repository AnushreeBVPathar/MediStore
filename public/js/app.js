...
function initAdmin(socket) {
  ...
  function renderItems(items) {
    ...
    return parseItems.map(function (menuItem) {
      return "\n                <p>".concat(menuItem.item.name, "- ").concat(menuItem.qty, " sheet</p>\n            ");
    }).join('');
  }
...
function updateCart(medicine) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', medicine).then(function (res) {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51IwlnUSJjfwNWwB4yAC9jcAz0qMCzVOdHIy5gTzxCNucN7MccbA267ZLmuwvX2Rzh0jYjeWwFjBO1MP5qqDdJjBy00DjzcGNT5');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmedical_shop"] = self["webpackChunkmedical_shop"] || [];
